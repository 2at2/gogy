...
func (o *LogLevel) SetFromString(v string) error {
	switch v {
	case DEBUG_LONG_STRING, DEBUG_SHORT_STRING:
		o.Code = DEBUG_CODE
		break
	case INFO_LONG_STRING, INFO_SHORT_STRING:
		o.Code = INFO_CODE
		break
	case NOTICE_LONG_STRING, NOTICE_SHORT_STRING:
		o.Code = NOTICE_CODE
		break
	case WARNING_LONG_STRING, WARNING_SHORT_STRING:
		o.Code = WARNING_CODE
		break
	case ERROR_LONG_STRING, ERROR_SHORT_STRING:
		o.Code = ERROR_CODE
		break
	case CRITICAL_LONG_STRING, CRITICAL_SHORT_STRING:
		o.Code = CRITICAL_CODE
		break
	case ALERT_LONG_STRING, ALERT_SHORT_STRING:
		o.Code = ALERT_CODE
		break
	case EMERGENCY_LONG_STRING, EMERGENCY_SHORT_STRING:
